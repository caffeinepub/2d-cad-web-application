...
export interface backendInterface {
    ...
    getProjectByName(name: string): Promise<ProjectPublic | null>;
    ...
    listProjects(): Promise<Array<ProjectPublic>>;
    loadProject(id: string): Promise<ProjectPublic | null>;
    rotateObject(projectId: string, objectIndex: bigint, rotation: number): Promise<boolean>;
    saveProject(id: string, name: string, objects: Array<DrawingObject>, layers: Array<[bigint, Layer]>, activeLayer: bigint, unitSystem: UnitSystem): Promise<void>;
    searchProjectsByName(searchTerm: string): Promise<Array<ProjectPublic>>;
    ...
    updateProject(id: string, objects: Array<DrawingObject>, layers: Array<[bigint, Layer]>, activeLayer: bigint, unitSystem: UnitSystem): Promise<boolean>;
}
